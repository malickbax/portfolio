...
<div class="gradient-x-three-sm-primary mt-6">
  ...
  <!-- Project picture frame -->
        <figure class="device-browser">
          ...
          <div class="device-browser-frame"><img class="device-browser-img" src="@/assets/img/1920x800/screenshot-runbuddy.png" alt="Run Buddy Website"></div>
        </figure>
      </div>
    </div>
  <!-- PROJECT ENDS -->
...
<!-- CONTACT SECTION STARTS HERE -->
  ...
  <!-- Nav Pills for ways to contact me -->
  ...
  <!-- Background Shape - contact me section-->
